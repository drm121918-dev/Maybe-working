...
bot = Client(
    ...
    bot_token=8095739923:AAG7FBm_YIHxaN_QnUN6fXo8hFTOtEjSiAE)
        ...
        for i in range(count - 1, len(links)):
            ...
            if "visionias" in url:
                ...
                headers = {
                    ...
                    'x-access-token': f'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..qKr76WgQEmFTuT0z8xoBhr4tfyRuv7EHqynRqvS67p44ipea6QoVp_j3aijATj_7',    
                    'accept-language': 'EN',
                    'api-version': '18',
